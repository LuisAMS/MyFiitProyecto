...
public class ClaseBluetooth {
    ...
    public ClaseBluetooth(Context context, Handler handler) {
    ...
    private synchronized void setState(int estado) {
        ...
        mHandler.obtainMessage(PrincipalActivity.Mensaje_Estado_Cambiado, estado, -1).sendToTarget();
    }
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
        ...
        Message msg = mHandler.obtainMessage(PrincipalActivity.Mensaje_Nombre_Dispositivo);
        Bundle bundle = new Bundle();
        bundle.putString(PrincipalActivity.DEVICE_NAME, device.getName());
        msg.setData(bundle);
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(PrincipalActivity.TOAST, "Error de conexion");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private class AcceptThread extends Thread {
        ...
        public void run() {
            ...
            while (EstadoActual != STATE_CONNECTED) {
                ...
                if (socket != null) {
                    synchronized (ClaseBluetooth.this) {
                        switch (EstadoActual) {
                            case STATE_LISTEN:
    ...
    /**
     * Esta hilo correra mientras se intente realizar una conexion de salida con un dispositivo.
     * Este correra a traves de la conexion ya sea establecida o fallada
     */
    private class ConnectThread extends Thread {
        ...
        public void run() {
            Log.e(TAG, "Comenzando HiloConectado");
    ...
    private class ConnectedThread extends Thread {
        ...
        public void write(byte[] buffer) {
            try {
                ...
                mHandler.obtainMessage(PrincipalActivity.Mensaje_Escrito, -1, -1, buffer).sendToTarget();
        ...
        public void run() {
            Log.e(TAG, "Comenzar HiloConectado");
            ...
            while (true) { //Mantiene escuchando el InputStream mientras este conectado
                try {
                    ...
                    mHandler.obtainMessage(PrincipalActivity.Mensaje_Leido, bytes, -1, buffer).sendToTarget(); //readMessageX por buffer
